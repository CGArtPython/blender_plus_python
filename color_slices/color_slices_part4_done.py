...
def gen_perlin_curve():
    ...
    curve_obj.data.bevel_object = create_bevel_object()
...
def animate_curve(context, shape_key):
    start_value = 1
    mid_value = 0
...
def gen_scene(context):
    ...
    animate_curve(context, shape_key)
...
def main():
    ...
    https://www.youtube.com/watch?v=e3eH1bq1D_U&list=PLB8-FQgROBmlzQ7Xkq4YU7u08Zh3iuyPD&index=5
    """
    context = setup_scene()
